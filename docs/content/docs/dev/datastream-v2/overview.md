...
Note: DataStream V2 API is a new set of APIs, to gradually replace the original DataStream API. It is currently in the experimental stage and is not fully available for production.
...
[Building Blocks](TODO: update link when this doc is ready): Given the most basic elements of DataStream API.
[State Processing](TODO: update link when this doc is ready): Explanation of how to develop stateful applications.
[Time Processing#Processing Timer Service](TODO: update link when this doc is ready): Explanation of how to handle processing time.
[Watermark](TODO: update link when this doc is ready): Explanation of how to define and handle user defined events.
...
More details can be found in:
[Time Processing#Event Timer Service](TODO: update link when this doc is ready): Explanation of how to handle event time via extension.
[Window, Join Extensions](TODO: update link when this doc is ready): Explanation of how to do window aggregation and join via extension.
...
using `ExecutionEnvironment.fromSource(source, sourceNmae)`. Flink comes with a number of pre-implemented
source, you can use FLIP-27 based source via `DataStreamV2SourceUtils.wrapSource(source)` or use 
...
NonKeyedPartitionStream<String> input = env.fromSource(
...
derived DataStreams. For other types of DataStream, see [Building Blocks#DataStream](TODO: update link when this doc is ready).
...
collection to an Integer. For more details of processing, see [Building Blocks#Process Function](TODO: update link when this doc is ready). 
...
* [Building Blocks](TODO: update link when this doc is ready)
* [State Processing](TODO: update link when this doc is ready)
* [Time Processing](TODO: update link when this doc is ready)
* [Window, Join Extensions](TODO: update link when this doc is ready):
* [Watermark](TODO: update link when this doc is ready)

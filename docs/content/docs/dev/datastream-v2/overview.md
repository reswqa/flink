...
- [Watermark]({{< ref "docs/dev/datastream-v2/watermark/define_watermark" >}}): Explanation of how to define and handle user defined events.
...
- [Window, Join Extensions]({{< ref "docs/dev/datastream-v2/extensions/joining" >}}): Explanation of how to do window aggregation and join via extension.
...
* [State Processing]({{< ref "docs/dev/datastream-v2/context_and_state_processing" >}})
* [Time Processing]({{< ref "docs/dev/datastream-v2/time-processing/processing_timer_service" >}})
* [Window, Join Extensions]({{< ref "docs/dev/datastream-v2/extensions" >}})

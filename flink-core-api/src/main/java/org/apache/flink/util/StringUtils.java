...
public final class StringUtils {
     ...
     */
    public static void writeStringNotNull(@Nonnull String str, DataOutputView out)
            throws IOException {
        checkNotNull(str);
        writeString(str, out);
    }

    public static void writeString(CharSequence cs, DataOutput out) throws IOException {
        if (cs != null) {

...
public class BooleanValueComparator extends TypeComparator<BooleanValue> {
    ...
    public void putNormalizedKey(
            BooleanValue record, MemorySegment target, int offset, int numBytes) {
    ...
    @Override
    public void writeWithKeyNormalization(BooleanValue record, DataOutputView target)
            throws IOException {
        throw new UnsupportedOperationException();
    }

    @Override
    public BooleanValue readWithKeyDenormalization(BooleanValue reuse, DataInputView source)
            throws IOException {
        throw new UnsupportedOperationException();
    }
}

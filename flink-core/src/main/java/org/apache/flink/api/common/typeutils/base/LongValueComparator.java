...
public class LongValueComparator extends TypeComparator<LongValue> {
    ...
    @Override
    public void writeWithKeyNormalization(LongValue record, DataOutputView target)
            throws IOException {
        throw new UnsupportedOperationException();
    }

    @Override
    public LongValue readWithKeyDenormalization(LongValue reuse, DataInputView source)
            throws IOException {
        throw new UnsupportedOperationException();
    }
}

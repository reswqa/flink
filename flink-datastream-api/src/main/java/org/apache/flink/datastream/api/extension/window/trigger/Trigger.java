...
package org.apache.flink.datastream.api.extension.window.trigger;
 ...
 * and same {@link Window}. An element can be in multiple panes if it was assigned to multiple
 ...
 *
 * <p>When used with a {@link MergingWindowAssigner} the {@code Trigger} must return {@code true}
 * from {@link #canMerge()} and {@link #onMerge(Window, OnMergeContext)} most be properly
 * implemented.
 *
...
public abstract class Trigger<T, W extends Window> implements Serializable {
    ...
    /**
     * Called when several windows have been merged into one window by the {@link WindowAssigner}.
     *
     ...
     * a window is purged. Timers set using {@link TriggerContext#registerEventTimeListener} and
     * {@link TriggerContext#registerProcessingTimeTimer(long)} should be deleted here as well as
     * state acquired using {@code TriggerContext#getWindowState}.
     */
    ...
    public interface TriggerContext {
        ...
        /**
         * Register an event time callback. When the current event time passes the specified event
         * time {@link Trigger#onEventTime(long, Window, TriggerContext)}} is called with the time
         * specified here.
         *
         * @param time The event time at which to invoke {@link Trigger#onEventTime(long, Window,
         *     TriggerContext)}
         */
        void registerEventTimeListener(long time);

        /** Delete the processing time trigger for the given time. */
        void deleteProcessingTimeTimer(long time);

        /** Delete the event time trigger for the given time. */
        void deleteEventTimeListener(long time);

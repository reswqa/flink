...
public class OneOutputEventTimeManager extends AbstractEventTimeManager {

    public OneOutputEventTimeManager(
    ...
    public void registerTimer(long timestamp, TwoOutputEventTimerCallback callback) {
        throw new UnsupportedOperationException(
                "Cannot register TwoOutputEventTimerCallback, please register EventTimerCallback instead.");
    }
}

...
import static org.apache.flink.datastream.impl.extension.window.window.TimeWindow.getWindowStartWithOffset;
...
public class TumblingProcessTimeWindowsAssigner extends WindowAssigner<Object, TimeWindow> {
     ...
     */
    public static TumblingProcessTimeWindowsAssigner of(Duration size) {
        return new TumblingProcessTimeWindowsAssigner(
                size.toMillis(), 0, WindowStagger.ALIGNED);
    }
     ...
     * @return The time policy.
     */
    public static TumblingProcessTimeWindowsAssigner of(Duration size, Duration offset) {
        return new TumblingProcessTimeWindowsAssigner(
    ...
    public static TumblingProcessTimeWindowsAssigner of(
        ...
        return new TumblingProcessTimeWindowsAssigner(
                size.toMillis(), offset.toMillis(), windowStagger);
    }
}

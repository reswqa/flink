...
/**
 * The {@link InternalReduceWindowFunction} is a type of {@link InternalWindowFunction} that
 * includes an additional {@code reduce} operation, which will be executed within the internal
 * StateBackend.
 */

...
public abstract class JoinOperator<I1, I2, OUT>
    ...
    protected JoinOperator(
        ...
        try {
            ...
            throw new InvalidProgramException(
                    "The types of the key fields do not match: " + ike.getMessage(), ike);
        }
        ...
        if (input1 instanceof SolutionSetPlaceHolder) {
            if (keys1 instanceof ExpressionKeys) {
                ...
                throw new InvalidProgramException(
                        "Currently, the solution set may only be joined with using tuple field positions.");
            }
        }
    ...
    public static class EquiJoin<I1, I2, OUT> extends JoinOperator<I1, I2, OUT> {
        ...
        protected DualInputSemanticProperties extractSemanticAnnotationsFromUdf(Class<?> udfClass) {
            if (function instanceof DefaultJoin.WrappingFlatJoinFunction) {
                return super.extractSemanticAnnotationsFromUdf(
                        ((WrappingFunction<?>) function).getWrappedFunction().getClass());
            } else {
        ...
        protected boolean udfWithForwardedFieldsSecondAnnotation(Class<?> udfClass) {
            ...
            if (function instanceof DefaultJoin.WrappingFlatJoinFunction) {
                return super.udfWithForwardedFieldsSecondAnnotation(
                        ((WrappingFunction<?>) function).getWrappedFunction().getClass());
            } else {
        ...
        protected JoinOperatorBase<?, ?, OUT, ?> translateToDataFlow(
            ...
            JoinOperatorBaseBuilder<OUT> builder =
            ...
            final boolean requiresTupleUnwrapping =
                    keys1 instanceof SelectorFunctionKeys || keys2 instanceof SelectorFunctionKeys;
            if (requiresTupleUnwrapping) {
                if (keys1 instanceof SelectorFunctionKeys
                    ...
                    builder =
                            builder.withUdf(new TupleUnwrappingJoiner<>(function))
                    ...
                    builder =
                            builder.withUdf(new TupleRightUnwrappingJoiner<>(function))
                    ...
                    builder =
                            builder.withUdf(new TupleLeftUnwrappingJoiner<>(function))
                                    .withWrappedInput1(input1, selectorKeys1)
        ...
        private static final class JoinOperatorBaseBuilder<OUT> {
            ...
            public <I1, K> JoinOperatorBaseBuilder<OUT> withWrappedInput1(
                    Operator<I1> input1, SelectorFunctionKeys<I1, ?> rawKeys1) {
            ...
            public <I2, K> JoinOperatorBaseBuilder<OUT> withWrappedInput2(
                    Operator<I2> input2, SelectorFunctionKeys<I2, ?> rawKeys2) {
            ...
            public <I1> JoinOperatorBaseBuilder<OUT> withInput1(
                    Operator<I1> input1, TypeInformation<I1> input1Type, Keys<?> keys1) {
                this.input1 = input1;
            ...
            public <I2> JoinOperatorBaseBuilder<OUT> withInput2(
                    Operator<I2> input2, TypeInformation<I2> input2Type, Keys<?> keys2) {
                this.input2 = input2;
                    ...
                    operator =
                            new OuterJoinOperatorBase<>(
                                    ...
                                    new BinaryOperatorInformation(
                                            input1Type, input2Type, resultType),
    ...
    public static final class DefaultJoin<I1, I2> extends EquiJoin<I1, I2, Tuple2<I1, I2>>
        ...
        public <R> EquiJoin<I1, I2, R> with(JoinFunction<I1, I2, R> function) {
            ...
            FlatJoinFunction<I1, I2, R> generatedFunction =
                    new WrappingFlatJoinFunction<>(clean(function));
            TypeInformation<R> returnType =
         ...
         * {@link org.apache.flink.api.java.operators.JoinOperator.ProjectJoin#projectFirst(int...)}
         * and {@link
         * org.apache.flink.api.java.operators.JoinOperator.ProjectJoin#projectSecond(int...)}.
         *
        ...
        public <OUT extends Tuple> ProjectJoin<I1, I2, OUT> projectFirst(int... firstFieldIndexes) {
            JoinProjection<I1, I2> joinProjection =
                    new JoinProjection<>(
                            getInput1(),
                            getInput2(),
                            getKeys1(),
        ...
        //			return new LeftSemiJoin<I1, I2>(getInput1(), getInput2(), getKeys1(), getKeys2(),
        // getJoinHint());
        //		}

        //		public JoinOperator<I1, I2, I2> rightSemiJoin() {
        //			return new RightSemiJoin<I1, I2>(getInput1(), getInput2(), getKeys1(), getKeys2(),
        // getJoinHint());
        //		}

        //		public JoinOperator<I1, I2, I1> leftAntiJoin() {
        //			return new LeftAntiJoin<I1, I2>(getInput1(), getInput2(), getKeys1(), getKeys2(),
        // getJoinHint());
        //		}

        //		public JoinOperator<I1, I2, I2> rightAntiJoin() {
        //			return new RightAntiJoin<I1, I2>(getInput1(), getInput2(), getKeys1(), getKeys2(),
        // getJoinHint());
        //		}
    }
    ...
    public static class ProjectJoin<I1, I2, OUT extends Tuple> extends EquiJoin<I1, I2, OUT> {
        ...
        protected ProjectJoin(
            ...
            super(
                    ...
                    keys1,
                    keys2,
                    new ProjectFlatJoinFunction<I1, I2, OUT>(
                            fields,
                            isFromFirst,
                            returnType
                                    .createSerializer(
                    ...
                    hint,
                    Utils.getCallLocationName(
                            4)); // We need to use the 4th element in the stack because the call
            // comes through .types().
         ...
         * passed.
         *
         * <p>Additional fields of the first and second input can be added by chaining the method
         * calls of {@link
         * org.apache.flink.api.java.operators.JoinOperator.ProjectJoin#projectFirst(int...)} and
         * {@link
         * org.apache.flink.api.java.operators.JoinOperator.ProjectJoin#projectSecond(int...)}.
         *
         * <p><b>Note: With the current implementation, the Project transformation loses type
        ...
        public JoinOperator<I1, I2, OUT> withForwardedFieldsFirst(String... forwardedFieldsFirst) {
            throw new InvalidProgramException(
                    "The semantic properties (forwarded fields) are automatically calculated.");
        }

        @Override
        public JoinOperator<I1, I2, OUT> withForwardedFieldsSecond(
                String... forwardedFieldsSecond) {
            throw new InvalidProgramException(
                    "The semantic properties (forwarded fields) are automatically calculated.");
        }
        ...
        protected DualInputSemanticProperties extractSemanticAnnotationsFromUdf(Class<?> udfClass) {
            ...
            return SemanticPropUtil.createProjectionPropertiesDual(
                    getFunction().getFields(),
    ...
    //
    //		protected LeftAntiJoin(DataSet<I1> input1, DataSet<I2> input2, Keys<I1> keys1, Keys<I2>
    // keys2, JoinHint hint) {
    ...
    //
    //		protected RightAntiJoin(DataSet<I1> input1, DataSet<I2> input2, Keys<I1> keys1, Keys<I2>
    // keys2, JoinHint hint) {
    ...
    //
    //		protected LeftSemiJoin(DataSet<I1> input1, DataSet<I2> input2, Keys<I1> keys1, Keys<I2>
    // keys2, JoinHint hint) {
    //			super(input1, input2, keys1, keys2, new LeftSemiJoinFunction<I1, I2>(), input1.getType(),
    // hint);
    //		}
    //
    //		@Override
    ...
    //
    //		protected RightSemiJoin(DataSet<I1> input1, DataSet<I2> input2, Keys<I1> keys1, Keys<I2>
    // keys2, JoinHint hint) {
    //			super(input1, input2, keys1, keys2, new RightSemiJoinFunction<I1, I2>(), input2.getType(),
    // hint);
    //		}
    //
    //		@Override
    ...
    public static final class JoinOperatorSets<I1, I2> extends JoinOperatorSetsBase<I1, I2> {
        ...
        public JoinOperatorSetsPredicate where(int... fields) {
            return new JoinOperatorSetsPredicate(
        ...
        public <K> JoinOperatorSetsPredicate where(KeySelector<I1, K> keySelector) {
            ...
            return new JoinOperatorSetsPredicate(
                    new SelectorFunctionKeys<>(
                            input1.clean(keySelector), input1.getType(), keyType));
        }
        ...
        public class JoinOperatorSetsPredicate extends JoinOperatorSetsPredicateBase {
             ...
             *
             * @param fields The indexes of the Tuple fields of the second join DataSet that should
             *     be used as keys.
    ...
    private static final class ProjectFlatJoinFunction<T1, T2, R extends Tuple>
        ...
        /**
         * Instantiates and configures a ProjectJoinFunction. Creates output tuples by copying
         * fields of joined input tuples (or a full input object) into an output tuple.
         *
         * @param fields List of indexes fields that should be copied to the output tuple. If the
         *     full input object should be copied (for example in case of a non-tuple input) the
         *     index should be -1.
         * @param isFromFirst List of flags indicating whether the field should be copied from the
         *     first (true) or the second (false) input.
        ...
        private ProjectFlatJoinFunction(int[] fields, boolean[] isFromFirst, R outTupleInstance) {
            if (fields.length != isFromFirst.length) {
                throw new IllegalArgumentException(
                        "Fields and isFromFirst arrays must have same length!");
            }
    ...
    private static final class JoinProjection<I1, I2> {
        ...
        public JoinProjection(
            ...
            if (firstFieldIndexes != null && secondFieldIndexes == null) {
                ...
                throw new IllegalArgumentException(
                        "You must provide at least one field index array.");
            } else {
                throw new IllegalArgumentException(
                        "You must provide at most one field index array.");
            }

            if (!isTuple && this.fieldIndexes.length != 0) {
                // field index provided for non-Tuple input
                throw new IllegalArgumentException(
                        "Input is not a Tuple. Call projectFirst() (or projectSecond()) without arguments to include it.");
            } else if (this.fieldIndexes.length > 22) {
                throw new IllegalArgumentException(
                        "You may select only up to twenty-two (22) fields.");
            }
        ...
        public <OUT extends Tuple> ProjectJoin<I1, I2, OUT> projectTupleX() {
            ...
            switch (fieldIndexes.length) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    projectJoin = (ProjectJoin<I1, I2, OUT>) projectTuple3();
                    break;
                case 4:
                    projectJoin = (ProjectJoin<I1, I2, OUT>) projectTuple4();
                    break;
                case 5:
                    projectJoin = (ProjectJoin<I1, I2, OUT>) projectTuple5();
                    break;
                case 6:
                    projectJoin = (ProjectJoin<I1, I2, OUT>) projectTuple6();
                    break;
                case 7:
                    projectJoin = (ProjectJoin<I1, I2, OUT>) projectTuple7();
                    break;
                case 8:
                ...
                case 9:
                    ...
                    break;
                case 10:
                    projectJoin = (ProjectJoin<I1, I2, OUT>) projectTuple10();
                    break;
                case 11:
                ...
                case 16:
                    ...
                    break;
                case 17:
                    projectJoin = (ProjectJoin<I1, I2, OUT>) projectTuple17();
                    break;
                case 18:
                ...
                case 22:
                    ...
                    break;
                case 23:
                    projectJoin = (ProjectJoin<I1, I2, OUT>) projectTuple23();
                    break;
                case 24:
        ...
        public <T0, T1, T2, T3> ProjectJoin<I1, I2, Tuple4<T0, T1, T2, T3>> projectTuple4() {
            ...
            return new ProjectJoin<I1, I2, Tuple4<T0, T1, T2, T3>>(
                    this.ds1,
                    this.ds2,
                    this.keys1,
                    this.keys2,
        ...
        public <T0, T1, T2, T3, T4, T5, T6>
            ...
            return new ProjectJoin<I1, I2, Tuple7<T0, T1, T2, T3, T4, T5, T6>>(
                    this.ds1,
                    this.ds2,
                    this.keys1,
                    this.keys2,
        ...
        public <T0, T1, T2, T3, T4, T5, T6, T7>
            ...
            return new ProjectJoin<I1, I2, Tuple8<T0, T1, T2, T3, T4, T5, T6, T7>>(
                    this.ds1,
                    this.ds2,
                    this.keys1,
                    this.keys2,
        ...
        public <T0, T1, T2, T3, T4, T5, T6, T7, T8>
            ...
            return new ProjectJoin<I1, I2, Tuple9<T0, T1, T2, T3, T4, T5, T6, T7, T8>>(
                    this.ds1,
                    this.ds2,
                    this.keys1,
                    this.keys2,
        ...
        public <T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>
            ...
            return new ProjectJoin<I1, I2, Tuple11<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>>(
                    this.ds1,
                    this.ds2,
                    this.keys1,
                    this.keys2,

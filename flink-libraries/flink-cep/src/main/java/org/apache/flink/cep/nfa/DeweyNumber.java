 ...
 *
 * <p>A dewey number consists of a sequence of digits d1.d2.d3. ... .dn. A dewey number v is
 * compatible to v' iff v contains v' as a prefix or if both dewey number differ only in the last
 * digit and the last digit of v is greater than v'.
 */

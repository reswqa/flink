...
@Internal
public class LockableTypeSerializerSnapshot<E>
        extends CompositeTypeSerializerSnapshot<Lockable<E>, Lockable.LockableTypeSerializer<E>> {
    ...
    public LockableTypeSerializerSnapshot(
            Lockable.LockableTypeSerializer<E> lockableTypeSerializer) {
    ...
    @Override
    protected Lockable.LockableTypeSerializer<E> createOuterSerializerWithNestedSerializers(
    ...
    protected TypeSerializer<?>[] getNestedSerializers(
            Lockable.LockableTypeSerializer<E> outerSerializer) {

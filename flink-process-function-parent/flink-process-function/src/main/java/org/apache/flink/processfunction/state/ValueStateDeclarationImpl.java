...
public class ValueStateDeclarationImpl<T> extends AbstractStateDeclaration
        implements StateDeclaration.ValueStateDeclaration {
    ...
    public boolean equals(Object o) {
        ...
        ValueStateDeclarationImpl<?> that = (ValueStateDeclarationImpl<?>) o;
        return Objects.equals(getTypeDescriptor(), that.getTypeDescriptor());
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), getTypeDescriptor());
    }
}

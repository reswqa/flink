...
public class SlidingProcessingTimeWindowsAssigner extends WindowAssigner<Object, TimeWindow> {
     ...
     */
    public static SlidingProcessingTimeWindowsAssigner of(Time size, Time slide) {
     ...
     * @return The time policy.
     */
    public static SlidingProcessingTimeWindowsAssigner of(Time size, Time slide, Time offset) {
        return new SlidingProcessingTimeWindowsAssigner(

...
/**
 * A {@link Transformation} for {@link Sink} in process function.
 *
 * @param <InputT> The input type of the {@link SinkWriter}
 * @param <OutputT> The output type of the {@link Sink}
 */
@Internal
public class PfSinkTransformation<InputT, OutputT> extends PhysicalTransformation<OutputT> {

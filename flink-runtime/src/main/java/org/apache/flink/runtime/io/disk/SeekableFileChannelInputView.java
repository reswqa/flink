 ...
 * data input stream. The view reads it data in blocks from the underlying channel. The view can
 * read data that has been written by a {@link FileChannelOutputView}, or that was written in blocks
 * in another fashion.
 */

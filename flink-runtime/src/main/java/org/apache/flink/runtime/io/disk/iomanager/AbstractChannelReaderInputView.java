...
/**
 * A {@link DataInputView} that is backed by a {@link FileIOChannel}, making it effectively a data
 * input stream. The view reads it data in blocks from the underlying channel. The view can only
 * read data that has been written by a {@link ChannelWriterOutputView}, due to block formatting.
 */

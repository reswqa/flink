 ...
 * possible.
 */
public class SelectiveSpillingStrategy implements TsSpillingStrategy {
    private final float spillBufferRatio;

    private final float spillThreshold;

    public SelectiveSpillingStrategy(TieredStoreConfiguration storeConfiguration) {
        spillThreshold = storeConfiguration.getSelectiveStrategySpillThreshold();
        spillBufferRatio = storeConfiguration.getSelectiveStrategySpillBufferRatio();
    }

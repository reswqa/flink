 ...
 */
public class SubpartitionLocalMemoryDataManager extends ResultSubpartition
        implements CheckpointedResultSubpartition, ChannelStateHolder {

    private static final Logger LOG = LoggerFactory.getLogger(SubpartitionLocalMemoryDataManager.class);
    ...
    /** The read consumer to consume this subpartition. */
    SubpartitionMemoryConsumer readView;
    ...
    public SubpartitionLocalMemoryDataManager(
            int index,
    ...
    public void release() {
        ...
        final SubpartitionMemoryConsumer view;
    ...
    @Override
    public SubpartitionMemoryConsumer createReadView(
        ...
        synchronized (buffers) {
            ...
            readView = new SubpartitionMemoryConsumer(this, availabilityListener);
        }
    ...
    private void notifyDataAvailable() {
        final SubpartitionMemoryConsumer readView = this.readView;
        if (readView != null) {

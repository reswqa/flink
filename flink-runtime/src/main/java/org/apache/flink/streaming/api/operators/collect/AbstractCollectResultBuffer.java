...
public abstract class AbstractCollectResultBuffer<T> {
    ...
    public void dealWithResponse(CollectCoordinationResponse response, long responseOffset)
            throws IOException {
    ...
    private void addResults(CollectCoordinationResponse response, long responseOffset)
            throws IOException {

...
/** Mock {@link BufferSpillingInfoProvider} for test. */
public class TestingSpillingInfoProvider implements BufferSpillingInfoProvider {
    ...
    private static boolean isBufferSatisfyStatus(
        ...
        switch (consumeStatusWithId.getStatus()) {
            case NOT_CONSUMED:
                isNeeded &= !isConsumed;
                break;
            case CONSUMED:

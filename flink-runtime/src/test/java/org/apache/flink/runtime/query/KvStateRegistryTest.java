...
class KvStateRegistryTest {
    ...
    void testKvStateEntry() throws InterruptedException {
        ...
        assertThat(infos).hasSize(threads);
        ...
        assertThat(kvState.getCacheSize()).isZero();
    ...
    void testKvStateRegistryListenerNotification() {
        ...
        assertThat(registeredNotifications2).isEmpty();
        ...
        assertThat(deregisteredNotifications1).isEmpty();
    }
    ...
    private static class DummyKvState implements InternalKvState<Integer, VoidNamespace, String> {
        ...
        public byte[] getSerializedValue(
                ...
                final TypeSerializer<String> safeValueSerializer)
                throws Exception {
            return serializedKeyAndNamespace;
        }

        @Override
        public StateIncrementalVisitor<Integer, VoidNamespace, String> getStateIncrementalVisitor(

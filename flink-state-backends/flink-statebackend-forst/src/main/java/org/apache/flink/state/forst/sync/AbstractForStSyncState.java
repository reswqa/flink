 ...
 */
public abstract class AbstractForStSyncState<K, N, V> implements InternalKvState<K, N, V>, State {
     ...
     */
    protected AbstractForStSyncState(
    ...
    protected AbstractForStSyncState<K, N, V> setNamespaceSerializer(
            TypeSerializer<N> namespaceSerializer) {
        this.namespaceSerializer = namespaceSerializer;
        return this;
    }

    protected AbstractForStSyncState<K, N, V> setValueSerializer(
            TypeSerializer<V> valueSerializer) {

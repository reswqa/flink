 ...
 */
public class ForStDBCachingPriorityQueueSet<E extends HeapPriorityQueueElement>
    ...
    @Nonnull private final ForStDBWriteBatchWrapper batchWrapper;
    ...
    ForStDBCachingPriorityQueueSet(
            ...
            @Nonnull ForStDBWriteBatchWrapper batchWrapper,

 ...
 */
class ForStSyncValueState<K, N, V> extends AbstractForStSyncState<K, N, V>
    ...
    static <K, N, SV, S extends State, IS extends S> IS update(
            ...
            IS existingState) {
        return (IS)
                ((ForStSyncValueState<K, N, SV>) existingState)

 ...
 * operators using {@link
 * org.apache.flink.streaming.api.operators.Output#emitWatermark(GeneralizedWatermark)}}. Operators
 * that do not internally buffer elements can always forward the watermark that they receive.

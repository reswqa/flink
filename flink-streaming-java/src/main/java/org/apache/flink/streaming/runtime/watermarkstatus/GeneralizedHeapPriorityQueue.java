 ...
 */
public class GeneralizedHeapPriorityQueue<
        T extends GeneralizedHeapPriorityQueue.HeapPriorityQueueElement<T>> {
    ...
    /**
     * Creates an empty {@link GeneralizedHeapPriorityQueue} with the requested initial capacity.
     *
     * @param minimumCapacity the minimum and initial capacity of this priority queue.
     */
    @SuppressWarnings("unchecked")
    public GeneralizedHeapPriorityQueue(@Nonnegative int minimumCapacity) {
    ...
    /**
     * Interface for objects that can be managed by a {@link GeneralizedHeapPriorityQueue}. Such an
     * object can only be contained in at most one {@link GeneralizedHeapPriorityQueue} at a time.
     */
    interface HeapPriorityQueueElement<T extends HeapPriorityQueueElement<T>>
            extends Comparable<T> {

        /**
         * The index that indicates that a {@link HeapPriorityQueueElement} object is not contained
         * in and managed by any {@link GeneralizedHeapPriorityQueue}. We do not strictly enforce
         * that internal indexes must be reset to this value when elements are removed from a {@link
         * GeneralizedHeapPriorityQueue}.
         */
        ...
        /**
         * Sets the current index of this object in the {@link GeneralizedHeapPriorityQueue} and
         * should only be called by the owning {@link GeneralizedHeapPriorityQueue}.
         *

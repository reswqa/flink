 ...
 * data from user define source to internal sql engine. In udx return value, User outputs java
 * format data to the SQL engine.
 *
 * <p>The following scenarios will use converter for internal data format to java format: In udx
 * method parameters, data from internal sql engine need to be provided to user udx. In sink, data
 * from internal sql engine need to be provided to user define sink.
 */
public class DataFormatConverters {
    ...
    public static DataFormatConverter getConverterForDataType(DataType originDataType) {
        ...
        switch (logicalType.getTypeRoot()) {
            ...
            case RAW:
                ...
                return new GenericConverter(typeInfo.createSerializer(new SerializerConfig()));
            default:
    ...
    public static final class PrimitiveByteArrayConverter extends IdentityConverter<byte[]> {
        ...
        public static final PrimitiveByteArrayConverter INSTANCE =
                new PrimitiveByteArrayConverter();
    ...
    public static final class PrimitiveLongArrayConverter
        ...
        public static final PrimitiveLongArrayConverter INSTANCE =
                new PrimitiveLongArrayConverter();
    ...
    public static final class PrimitiveFloatArrayConverter
        ...
        public static final PrimitiveFloatArrayConverter INSTANCE =
                new PrimitiveFloatArrayConverter();
            ...
            for (int i = 0; i < value.length; i++) {
                ...
                if (field == null) {
                    ...
                    BinaryWriter.write(
                            reuseWriter,
                            i,
                            elementConverter.toInternalImpl(value[i]),
                            elementType,
                            eleSer);
                }
            }
    ...
    private static <T> T[] arrayDataToJavaArray(
        ...
        for (int i = 0; i < size; i++) {
            if (value.isNullAt(i)) {
                ...
                values[i] =
                        elementConverter.toExternalImpl(elementGetter.getElementOrNull(value, i));
            }
        }
        return values;
    }
    ...
    public abstract static class AbstractRowDataConverter<E>
    ...
    public static final class CaseClassConverter extends AbstractRowDataConverter<Object> {
        ...
        public CaseClassConverter(TupleTypeInfoBase t, DataType[] fieldTypes) {
            super(fieldTypes);
            this.t = t;
            this.serializer = (TupleSerializerBase) t.createSerializer(new SerializerConfig());
        }
